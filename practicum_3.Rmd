...
#note that we get more power using the difference in differences estimation. This is because diff-in-diff increases the precision of our estimate of the ATE. Though in this case they are both pretty powerful
```
